...
def drawcompass(glpane,
    ...
    of model coordinates) in the specified corner of the GLPane.
    ...
    if displayCompassLabels:
        ...
        glpane.renderText(p4, 0.0, 0.0, QString("x"), font)
        glpane.qglColor(QColor(25, 100, 25)) # Dark Green
        glpane.renderText(0.0, p4, 0.0, QString("y"), font)
        glpane.qglColor(QColor(50, 50, 200)) # Dark Blue
        glpane.renderText(0.0, 0.0, p4+0.2, QString("z"), font)
        ## glPopMatrix()
