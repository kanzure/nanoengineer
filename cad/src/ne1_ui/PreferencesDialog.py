...
#
# Created: Wed May 21 12:26:35 2008
...
class Ui_PreferencesDialog(object):
    def setupUi(self, PreferencesDialog):
        ...
        PreferencesDialog.resize(QtCore.QSize(QtCore.QRect(0,0,750,550).size()).expandedTo(PreferencesDialog.minimumSizeHint()))
        PreferencesDialog.setMinimumSize(QtCore.QSize(750,550))
        ...
        self.gridlayout3 = QtGui.QGridLayout(self.ModelView)
        ...
        self.label_8 = QtGui.QLabel(self.ModelView)
        self.label_8.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_8.setObjectName("label_8")
        self.hboxlayout.addWidget(self.label_8)

        self.backgroundColorComboBox = QtGui.QComboBox(self.ModelView)
        ...
        self.bg_groupbox = QtGui.QGroupBox(self.ModelView)
        self.bg_groupbox.setObjectName("bg_groupbox")

        self.gridlayout4 = QtGui.QGridLayout(self.bg_groupbox)
        self.gridlayout4.setMargin(4)
        self.gridlayout4.setSpacing(4)
        self.gridlayout4.setObjectName("gridlayout4")

        spacerItem2 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout4.addItem(spacerItem2,0,1,1,1)
        ...
        self.vboxlayout4.addWidget(self.restore_bgcolor_btn)
        self.gridlayout4.addLayout(self.vboxlayout4,0,0,1,1)
        self.vboxlayout3.addWidget(self.bg_groupbox)

        self.default_display_grpBox = QtGui.QGroupBox(self.ModelView)
        self.default_display_grpBox.setObjectName("default_display_grpBox")

        self.vboxlayout7 = QtGui.QVBoxLayout(self.default_display_grpBox)
        ...
        self.gridlayout5 = QtGui.QGridLayout(self.compassGroupBox)
        self.gridlayout5.setMargin(4)
        self.gridlayout5.setSpacing(4)
        self.gridlayout5.setObjectName("gridlayout5")

        spacerItem3 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout5.addItem(spacerItem3,0,1,1,1)
        ...
        self.vboxlayout8.addWidget(self.display_compass_labels_checkbox)
        self.gridlayout5.addLayout(self.vboxlayout8,0,0,1,1)
        ...
        self.vboxlayout3.addWidget(self.groupBox7_2)
        ...
        self.gridlayout3.addItem(spacerItem5,0,1,1,1)
        ...
        self.gridlayout7 = QtGui.QGridLayout(self.ZoomPanRotate)
        self.gridlayout7.setMargin(9)
        self.gridlayout7.setSpacing(6)
        self.gridlayout7.setObjectName("gridlayout7")

        spacerItem6 = QtGui.QSpacerItem(231,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout7.addItem(spacerItem6,0,1,1,1)
        ...
        self.hboxlayout4.addWidget(self.animate_views_checkbox)
        ...
        self.vboxlayout10.addWidget(self.textLabel1_5)
        ...
        self.gridlayout9.addWidget(self.resetMouseSpeedDuringRotation_btn,3,3,1,1)
        ...
        self.gridlayout9.addWidget(self.animation_speed_slider,1,0,1,3)

        self.textLabel3_4 = QtGui.QLabel(self.groupBox8)
        self.textLabel3_4.setObjectName("textLabel3_4")
        self.gridlayout9.addWidget(self.textLabel3_4,0,2,1,1)
        self.hboxlayout5.addLayout(self.gridlayout9)
        self.gridlayout8.addLayout(self.hboxlayout5,1,0,1,1)
        self.vboxlayout9.addWidget(self.groupBox8)
        ...
        self.vboxlayout11.addWidget(self.mouseWheelDirectionComboBox)
        ...
        self.vboxlayout11.addWidget(self.mouseWheelZoomInPointComboBox)
        ...
        self.vboxlayout11.addWidget(self.mouseWheelZoomOutPointComboBox)
        self.gridlayout10.addLayout(self.vboxlayout11,0,1,1,1)
        ...
        self.gridlayout12 = QtGui.QGridLayout(self.rulersGroupBox)
        ...
        self.gridlayout12.addWidget(self.label_5,3,0,1,1)
        ...
        self.gridlayout12.addWidget(self.textLabel3_2_4,2,0,1,1)
        ...
        self.gridlayout12.addWidget(self.rulerPositionComboBox,1,1,1,1)
        ...
        self.gridlayout12.addLayout(self.hboxlayout6,2,1,1,1)
        ...
        self.gridlayout12.addWidget(self.rulerOpacitySpinBox,3,1,1,1)
        ...
        self.gridlayout12.addWidget(self.rulerDisplayComboBox,0,1,1,1)

        self.label_12 = QtGui.QLabel(self.rulersGroupBox)
        self.label_12.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_12.setObjectName("label_12")
        self.gridlayout12.addWidget(self.label_12,0,0,1,1)
        ...
        self.gridlayout12.addWidget(self.showRulersInPerspectiveViewCheckBox,4,0,1,2)
        self.vboxlayout13.addWidget(self.rulersGroupBox)

        spacerItem17 = QtGui.QSpacerItem(20,40,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.vboxlayout13.addItem(spacerItem17)
        ...
        self.gridlayout13 = QtGui.QGridLayout(self.Atoms)
        ...
        self.gridlayout14 = QtGui.QGridLayout(self.atom_colors_grpbox)
        ...
        self.gridlayout14.addLayout(self.hboxlayout7,0,0,1,1)
        ...
        self.gridlayout15.addWidget(self.textLabel3_2_3,0,0,1,1)
        ...
        self.gridlayout15.addWidget(self.hotspot_lbl_2,2,0,1,1)
        ...
        self.gridlayout15.addWidget(self.hotspot_lbl,3,0,1,1)
        ...
        self.gridlayout15.addLayout(self.hboxlayout8,2,1,1,1)
        ...
        self.gridlayout15.addLayout(self.hboxlayout9,0,1,1,1)
        ...
        self.gridlayout15.addLayout(self.hboxlayout10,3,1,1,1)
        ...
        self.gridlayout14.addWidget(self.groupBox13,1,0,1,1)
        ...
        self.hboxlayout13.addItem(spacerItem22)
        ...
        self.gridlayout13.addLayout(self.vboxlayout14,0,0,1,1)
        self.prefsStackedWidget.addWidget(self.Atoms)

        self.Bonds = QtGui.QWidget()
        self.Bonds.setObjectName("Bonds")

        self.gridlayout16 = QtGui.QGridLayout(self.Bonds)
        ...
        self.gridlayout16.addItem(spacerItem24,0,1,1,1)
        ...
        self.gridlayout17.addWidget(self.textLabel3_2,0,0,1,1)
        ...
        self.hboxlayout15.addWidget(self.bond_stretch_color_frame)
        ...
        self.hboxlayout15.addWidget(self.bond_stretch_color_btn)
        self.gridlayout17.addLayout(self.hboxlayout15,2,1,1,1)
        ...
        self.hboxlayout16.addWidget(self.bond_hilite_color_frame)
        ...
        self.hboxlayout16.addWidget(self.bond_hilite_color_btn)
        self.gridlayout17.addLayout(self.hboxlayout16,0,1,1,1)
        ...
        self.gridlayout17.addWidget(self.textLabel3_3,3,0,1,1)
        ...
        self.hboxlayout17.addWidget(self.ballstick_bondcolor_frame)
        ...
        self.hboxlayout17.addWidget(self.ballstick_bondcolor_btn)
        self.gridlayout17.addLayout(self.hboxlayout17,1,1,1,1)
        ...
        self.gridlayout17.addWidget(self.textLabel3,1,0,1,1)
        ...
        self.gridlayout17.addWidget(self.textLabel3_2_2,2,0,1,1)
        ...
        self.hboxlayout18.addWidget(self.bond_vane_color_frame)
        ...
        self.hboxlayout18.addWidget(self.bond_vane_color_btn)
        self.gridlayout17.addLayout(self.hboxlayout18,3,1,1,1)
        self.vboxlayout17.addLayout(self.gridlayout17)
        ...
        self.hboxlayout19.addItem(spacerItem25)
        ...
        self.vboxlayout17.addLayout(self.hboxlayout19)
        ...
        self.hboxlayout20.addItem(spacerItem26)
        ...
        self.vboxlayout16.addItem(spacerItem27)
        self.gridlayout16.addLayout(self.vboxlayout16,0,0,1,1)
        self.prefsStackedWidget.addWidget(self.Bonds)

        self.DNA = QtGui.QWidget()
        self.DNA.setObjectName("DNA")

        self.gridlayout18 = QtGui.QGridLayout(self.DNA)
        ...
        self.hboxlayout21.setSpacing(2)
        ...
        self.hboxlayout21.addWidget(self.strandFivePrimeArrowheadsCustomColorCheckBox)
        ...
        self.hboxlayout22.addWidget(self.strandFivePrimeArrowheadsCustomColorFrame)
        ...
        self.hboxlayout22.addWidget(self.strandFivePrimeArrowheadsCustomColorPushButton)
        self.hboxlayout21.addLayout(self.hboxlayout22)
        self.gridlayout19.addLayout(self.hboxlayout21,4,0,1,1)

        self.hboxlayout23 = QtGui.QHBoxLayout()
        self.hboxlayout23.setMargin(0)
        self.hboxlayout23.setSpacing(2)
        ...
        self.gridlayout19.addLayout(self.hboxlayout23,3,0,1,1)
        ...
        self.vboxlayout22.addItem(spacerItem28)
        self.gridlayout18.addLayout(self.vboxlayout22,0,1,1,1)
        ...
        self.gridlayout20 = QtGui.QGridLayout(self.groupBox)
        ...
        self.hboxlayout25.addItem(spacerItem29)
        ...
        self.hboxlayout25.addWidget(self.dnaRestoreFactoryDefaultsPushButton)
        self.gridlayout20.addLayout(self.hboxlayout25,1,0,1,1)
        ...
        self.gridlayout21.addWidget(self.label_7,3,0,1,1)
        ...
        self.gridlayout21.addLayout(self.hboxlayout26,3,1,1,1)
        ...
        self.gridlayout22 = QtGui.QGridLayout(self.dnaDisplayMinorGrooveErrorGroupBox)
        ...
        self.gridlayout22.addLayout(self.vboxlayout24,0,0,1,1)
        ...
        self.gridlayout22.addLayout(self.vboxlayout25,0,1,1,1)
        ...
        self.gridlayout22.addLayout(self.hboxlayout28,1,0,1,2)
        ...
        self.gridlayout23 = QtGui.QGridLayout(self.dnaDisplayBaseOrientationIndicatorsGroupBox)
        ...
        self.gridlayout23.addWidget(self.dnaBaseIndicatorsPlaneNormalComboBox,0,1,1,1)
        ...
        self.gridlayout23.addWidget(self.bg1_color_lbl_6,2,0,1,1)
        ...
        self.gridlayout23.addLayout(self.hboxlayout29,2,1,1,1)
        ...
        self.gridlayout23.addWidget(self.dnaBaseOrientationIndicatorsInverseCheckBox,3,0,1,2)
        ...
        self.gridlayout23.addWidget(self.label_35,0,0,1,1)
        ...
        self.gridlayout23.addWidget(self.label_13,4,0,1,1)
        ...
        self.gridlayout23.addWidget(self.dnaBaseOrientationIndicatorsTerminalDistanceSpinBox,5,1,1,1)
        ...
        self.gridlayout23.addWidget(self.dnaBaseOrientationIndicatorsThresholdSpinBox,4,1,1,1)
        ...
        self.gridlayout23.addLayout(self.hboxlayout30,1,1,1,1)
        ...
        self.gridlayout23.addWidget(self.label_14,5,0,1,1)
        ...
        self.gridlayout23.addWidget(self.bg1_color_lbl_5,1,0,1,1)
        self.vboxlayout23.addWidget(self.dnaDisplayBaseOrientationIndicatorsGroupBox)

        spacerItem31 = QtGui.QSpacerItem(20,1,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.vboxlayout23.addItem(spacerItem31)
        self.gridlayout18.addLayout(self.vboxlayout23,0,0,1,1)

        spacerItem32 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout18.addItem(spacerItem32,0,2,1,1)
        self.prefsStackedWidget.addWidget(self.DNA)

        self.Adjust = QtGui.QWidget()
        self.Adjust.setObjectName("Adjust")

        self.gridlayout24 = QtGui.QGridLayout(self.Adjust)
        ...
        self.vboxlayout27 = QtGui.QVBoxLayout(self.adjustPhysicsEngineGroupBox)
        ...
        self.vboxlayout27.addWidget(self.adjustEngineCombobox)
        ...
        self.vboxlayout26.addWidget(self.adjustPhysicsEngineGroupBox)
        ...
        self.vboxlayout28.setSpacing(0)
        ...
        self.hboxlayout31.addWidget(self.update_every_rbtn)
        ...
        self.hboxlayout31.addWidget(self.update_number_spinbox)
        ...
        self.hboxlayout31.addWidget(self.update_units_combobox)
        self.vboxlayout28.addLayout(self.hboxlayout31)
        self.vboxlayout26.addWidget(self.update_btngrp)
        ...
        self.hboxlayout32 = QtGui.QHBoxLayout(self.groupBox20)
        self.hboxlayout32.setMargin(4)
        ...
        self.vboxlayout29.setSpacing(2)
        ...
        self.hboxlayout32.addLayout(self.vboxlayout29)
        ...
        self.vboxlayout30.addWidget(self.endRmsDoubleSpinBox)
        ...
        self.vboxlayout30.addWidget(self.endMaxDoubleSpinBox)
        ...
        self.vboxlayout30.addWidget(self.cutoverRmsDoubleSpinBox)
        ...
        self.vboxlayout30.addWidget(self.cutoverMaxDoubleSpinBox)
        self.hboxlayout32.addLayout(self.vboxlayout30)

        spacerItem33 = QtGui.QSpacerItem(80,20,QtGui.QSizePolicy.MinimumExpanding,QtGui.QSizePolicy.Minimum)
        self.hboxlayout32.addItem(spacerItem33)
        self.vboxlayout26.addWidget(self.groupBox20)

        spacerItem34 = QtGui.QSpacerItem(20,40,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.vboxlayout26.addItem(spacerItem34)
        self.gridlayout24.addLayout(self.vboxlayout26,0,0,2,1)
        ...
        self.gridlayout26 = QtGui.QGridLayout(self.groupBox8_2)
        self.gridlayout26.setMargin(4)
        self.gridlayout26.setSpacing(4)
        ...
        self.hboxlayout33.addWidget(self.light_combobox)
        ...
        self.vboxlayout32.addLayout(self.hboxlayout33)
        ...
        self.hboxlayout34.addWidget(self.light_checkbox)

        spacerItem37 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.hboxlayout34.addItem(spacerItem37)
        self.vboxlayout32.addLayout(self.hboxlayout34)
        ...
        self.hboxlayout36.addWidget(self.light_color_frame)
        ...
        self.hboxlayout36.addWidget(self.light_color_btn)
        ...
        self.vboxlayout32.addLayout(self.hboxlayout35)
        ...
        self.hboxlayout37.addWidget(self.light_ambient_linedit)
        ...
        self.hboxlayout37.addWidget(self.light_ambient_slider)
        self.vboxlayout32.addLayout(self.hboxlayout37)
        ...
        self.hboxlayout38.addWidget(self.light_diffuse_linedit)
        ...
        self.hboxlayout38.addWidget(self.light_diffuse_slider)
        ...
        self.hboxlayout39.addWidget(self.light_specularity_linedit)
        ...
        self.hboxlayout39.addWidget(self.light_specularity_slider)
        ...
        self.hboxlayout40.addWidget(self.light_x_linedit)
        ...
        self.hboxlayout41.addWidget(self.light_y_linedit)
        ...
        self.hboxlayout42.addWidget(self.light_z_linedit)
        ...
        self.gridlayout26.addLayout(self.vboxlayout32,0,1,1,1)
        ...
        self.gridlayout26.addLayout(self.vboxlayout33,0,0,1,1)
        self.vboxlayout31.addWidget(self.groupBox8_2)

        self.groupBox9_2 = QtGui.QGroupBox(self.Lighting)
        self.groupBox9_2.setEnabled(True)
        self.groupBox9_2.setObjectName("groupBox9_2")

        self.hboxlayout43 = QtGui.QHBoxLayout(self.groupBox9_2)
        self.hboxlayout43.setMargin(4)
        self.hboxlayout43.setSpacing(4)
        self.hboxlayout43.setObjectName("hboxlayout43")

        self.hboxlayout44 = QtGui.QHBoxLayout()
        self.hboxlayout44.setMargin(0)
        self.hboxlayout44.setSpacing(2)
        ...
        self.vboxlayout34.addWidget(self.ms_on_label)

        spacerItem42 = QtGui.QSpacerItem(70,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.vboxlayout34.addItem(spacerItem42)
        ...
        self.vboxlayout34.addWidget(self.ms_brightness__label)
        self.hboxlayout44.addLayout(self.vboxlayout34)
        ...
        self.vboxlayout35.addWidget(self.ms_on_checkbox)

        spacerItem45 = QtGui.QSpacerItem(50,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Minimum)
        ...
        self.vboxlayout35.addWidget(self.ms_finish_linedit)

        spacerItem46 = QtGui.QSpacerItem(50,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Minimum)
        ...
        self.vboxlayout35.addWidget(self.ms_shininess_linedit)

        spacerItem47 = QtGui.QSpacerItem(50,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Minimum)
        ...
        self.vboxlayout35.addWidget(self.ms_brightness_linedit)
        self.hboxlayout44.addLayout(self.vboxlayout35)
        ...
        spacerItem48 = QtGui.QSpacerItem(100,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.vboxlayout36.addItem(spacerItem48)

        self.hboxlayout45 = QtGui.QHBoxLayout()
        self.hboxlayout45.setMargin(0)
        self.hboxlayout45.setSpacing(4)
        ...
        self.vboxlayout36.addLayout(self.hboxlayout45)
        ...
        self.vboxlayout36.addWidget(self.ms_finish_slider)
        ...
        self.vboxlayout36.addLayout(self.hboxlayout46)
        ...
        self.vboxlayout36.addWidget(self.ms_shininess_slider)

        self.hboxlayout47 = QtGui.QHBoxLayout()
        self.hboxlayout47.setMargin(0)
        self.hboxlayout47.setSpacing(4)
        ...
        self.vboxlayout36.addLayout(self.hboxlayout47)
        ...
        self.vboxlayout36.addWidget(self.ms_brightness_slider)
        self.hboxlayout44.addLayout(self.vboxlayout36)
        self.hboxlayout43.addLayout(self.hboxlayout44)
        self.vboxlayout31.addWidget(self.groupBox9_2)

        spacerItem52 = QtGui.QSpacerItem(20,5,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.vboxlayout31.addItem(spacerItem52)
        self.gridlayout25.addLayout(self.vboxlayout31,0,0,2,1)
        ...
        spacerItem53 = QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        ...
        self.hboxlayout48.addWidget(self.lighting_restore_defaults_btn)
        self.gridlayout25.addLayout(self.hboxlayout48,1,1,1,1)

        spacerItem54 = QtGui.QSpacerItem(30,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout25.addItem(spacerItem54,0,1,1,1)
        ...
        self.gridlayout28.setSpacing(2)
        ...
        self.hboxlayout49.addWidget(self.qutemol_checkbox)
        ...
        self.hboxlayout49.addWidget(self.qutemol_lbl)
        self.gridlayout28.addLayout(self.hboxlayout49,0,0,1,1)
        ...
        self.hboxlayout50.addWidget(self.nanohive_checkbox)
        ...
        self.hboxlayout50.addWidget(self.nanohive_lbl)
        self.gridlayout28.addLayout(self.hboxlayout50,1,0,1,1)
        ...
        self.hboxlayout51.addWidget(self.povray_checkbox)
        ...
        self.hboxlayout51.addWidget(self.povray_lbl)
        self.gridlayout28.addLayout(self.hboxlayout51,2,0,1,1)
        ...
        self.hboxlayout52.addWidget(self.megapov_checkbox)
        ...
        self.hboxlayout52.addWidget(self.megapov_lbl)
        self.gridlayout28.addLayout(self.hboxlayout52,3,0,1,1)
        ...
        self.hboxlayout53.addWidget(self.povdir_checkbox)
        ...
        self.hboxlayout53.addWidget(self.povdir_lbl)
        self.gridlayout28.addLayout(self.hboxlayout53,4,0,1,1)
        ...
        self.hboxlayout54.addWidget(self.gamess_checkbox)
        ...
        self.hboxlayout54.addWidget(self.gamess_lbl)
        self.gridlayout28.addLayout(self.hboxlayout54,5,0,1,1)
        ...
        self.gridlayout28.addLayout(self.hboxlayout55,7,0,1,1)
        ...
        self.gridlayout28.addLayout(self.hboxlayout56,6,0,1,1)
        ...
        self.gridlayout28.addLayout(self.hboxlayout57,8,0,1,1)
        ...
        self.gridlayout27.addItem(spacerItem55,1,0,1,1)
        ...
        self.gridlayout29.addItem(spacerItem56,0,1,1,1)
        ...
        self.vboxlayout38.setSpacing(2)
        ...
        self.vboxlayout38.addLayout(self.hboxlayout58)
        ...
        self.history_widget_height_lbl.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.vboxlayout37.addItem(spacerItem57)
        ...
        self.hboxlayout59.setSpacing(4)
        ...
        self.gridlayout31.addLayout(self.hboxlayout59,0,0,1,1)

        self.hboxlayout60 = QtGui.QHBoxLayout()
        self.hboxlayout60.setMargin(0)
        self.hboxlayout60.setSpacing(4)
        ...
        self.hboxlayout60.addItem(spacerItem59)
        self.gridlayout31.addLayout(self.hboxlayout60,1,0,1,1)

        spacerItem60 = QtGui.QSpacerItem(20,40,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.gridlayout31.addItem(spacerItem60,3,0,1,1)

        self.hboxlayout61 = QtGui.QHBoxLayout()
        self.hboxlayout61.setMargin(0)
        self.hboxlayout61.setSpacing(4)
        ...
        self.vboxlayout41.addLayout(self.hboxlayout62)
        ...
        self.vboxlayout43.addItem(spacerItem62)
        self.hboxlayout61.addLayout(self.vboxlayout43)

        spacerItem63 = QtGui.QSpacerItem(280,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.hboxlayout61.addItem(spacerItem63)
        self.gridlayout31.addLayout(self.hboxlayout61,2,0,1,1)
        ...
        self.gridlayout36.addItem(spacerItem64,0,1,1,1)
        ...
        self.gridlayout37.setSpacing(2)
        ...
        self.hboxlayout63.addLayout(self.gridlayout37)
        ...
        self.vboxlayout46.addLayout(self.hboxlayout63)
        ...
        self.gridlayout38.setSpacing(0)
        ...
        self.vboxlayout45.addItem(spacerItem66)
        ...
        self.hboxlayout64.addWidget(self.okButton)

        self.whatsThisToolButton = QtGui.QToolButton(PreferencesDialog)
        self.whatsThisToolButton.setObjectName("whatsThisToolButton")
        self.hboxlayout64.addWidget(self.whatsThisToolButton)
        self.gridlayout.addLayout(self.hboxlayout64,1,0,1,1)
    ...
    def retranslateUi(self, PreferencesDialog):
        ...
        self.bg_groupbox.setTitle(QtGui.QApplication.translate("PreferencesDialog", "Background color (old way)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cpk_rbtn.setText(QtGui.QApplication.translate("PreferencesDialog", "CPK (space filling)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.historyHeight_spinbox.setSuffix(QtGui.QApplication.translate("PreferencesDialog", " lines", None, QtGui.QApplication.UnicodeUTF8))
        ...
        item1.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Model View", None, QtGui.QApplication.UnicodeUTF8))

        item2 = QtGui.QTreeWidgetItem(item1)
        item2.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Zoom, Pan and Rotate", None, QtGui.QApplication.UnicodeUTF8))

        item3 = QtGui.QTreeWidgetItem(item1)
        item3.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Rulers", None, QtGui.QApplication.UnicodeUTF8))

        item4 = QtGui.QTreeWidgetItem(self.categoryTreeWidget)
        item4.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Atoms", None, QtGui.QApplication.UnicodeUTF8))

        item5 = QtGui.QTreeWidgetItem(self.categoryTreeWidget)
        item5.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Bonds", None, QtGui.QApplication.UnicodeUTF8))

        item6 = QtGui.QTreeWidgetItem(self.categoryTreeWidget)
        item6.setText(0,QtGui.QApplication.translate("PreferencesDialog", "DNA", None, QtGui.QApplication.UnicodeUTF8))

        item7 = QtGui.QTreeWidgetItem(self.categoryTreeWidget)
        item7.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Adjust", None, QtGui.QApplication.UnicodeUTF8))

        item8 = QtGui.QTreeWidgetItem(self.categoryTreeWidget)
        item8.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Lighting", None, QtGui.QApplication.UnicodeUTF8))

        item9 = QtGui.QTreeWidgetItem(self.categoryTreeWidget)
        item9.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Plug-ins", None, QtGui.QApplication.UnicodeUTF8))

        item10 = QtGui.QTreeWidgetItem(self.categoryTreeWidget)
        item10.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Undo", None, QtGui.QApplication.UnicodeUTF8))

        item11 = QtGui.QTreeWidgetItem(self.categoryTreeWidget)
        item11.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Window", None, QtGui.QApplication.UnicodeUTF8))

        item12 = QtGui.QTreeWidgetItem(self.categoryTreeWidget)
        item12.setText(0,QtGui.QApplication.translate("PreferencesDialog", "Tooltips", None, QtGui.QApplication.UnicodeUTF8))
