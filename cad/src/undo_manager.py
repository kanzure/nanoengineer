...
and package the undo/redo ops it offers into a reasonable form for supporting a UI.
...
##                        non_debug = True)
    ...
    def remake_UI_menuitems(self): #e this should also be called again if any undo-related preferences change ###@@@
        ...
        from gui.whatsthis import refix_whatsthis_text_and_links
        import gui.whatsthis
        if 0:
            ...
            from gui.whatsthis import fix_whatsthis_text_and_links
