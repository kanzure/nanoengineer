...
image0_data = \
    ...
    "\x75\x49\x44\x41\x54\x38\x8d\xad\xd3\x21\xae\xf2" \
    "\x40\x18\x85\xe1\x77\x48\x49\x8a\x43\xb2\x80\x0a" \
    "\x44\x49\x10\xc5\x21\x10\x48\x24\xa2\x0b\x60\x21" \
    "\x18\x7c\xf1\x08\x16\x80\xa8\xa8\xe8\x02\xba\x00" \
    "\x04\x92\x05\x54\x56\x94\x64\x04\xe4\xfc\xe2\x07" \
    "\x02\x94\x72\xb9\x17\x4e\x32\x49\x67\xd2\x3e\xf9" \
    "\xa6\xf3\x8d\x91\x24\xbe\x98\xc6\x37\xb1\x0a\x78" \
    "\x3a\x9d\x58\x2e\x97\x0c\x06\x03\x9a\xcd\x26\xc6" \
    "\x18\x7a\xbd\x1e\x8b\xc5\x82\xc3\xe1\xf0\x14\x30" \
    "\xc6\xdc\x2f\xe8\x9c\xb2\x2c\x35\x1a\x8d\x04\x3c" \
    "\x1d\xbe\xef\x2b\xcf\x73\x3d\xe6\x86\xf8\x3f\xbf" \
    "\x3c\x4c\xa7\x53\x01\xea\x76\xbb\x4a\xd3\x54\xd6" \
    "\x5a\x1d\x8f\x47\x65\x59\xa6\x20\x08\x04\x68\x38" \
    "\x1c\xbe\x07\x66\x59\x26\x40\x9e\xe7\xa9\x2c\xcb" \
    "\xca\x47\x65\x59\x5e\xd1\x24\x49\x7e\x06\x67\xb3" \
    "\x99\x00\x6d\x36\x9b\x0a\x76\x49\x1c\xc7\x02\x14" \
    "\x86\xe1\xcf\xa0\xef\xfb\x02\x54\x14\x45\x2d\x58" \
    "\x14\xc5\x75\x17\xaf\x40\x23\x49\xad\x56\x0b\x6b" \
    "\xed\xdb\xad\xa1\x9b\xd6\x35\xc6\xdc\xcf\x25\xa9" \
    "\x72\xf4\x1f\x80\x0d\x00\xc7\x71\x00\xb0\xd6\x72" \
    "\xfe\x0d\x2f\xc7\xab\x34\x00\x3c\xcf\x03\x60\xbb" \
    "\xdd\xfe\xaa\xd2\x5a\x30\x08\x02\x00\xe2\x38\xfe" \
    "\x18\x44\x92\x92\x24\x11\x20\xd7\x75\xb5\xdb\xed" \
    "\x9e\x9e\xf2\x7a\xbd\x7e\xda\xdc\xd4\xdd\x94\xf1" \
    "\x78\x2c\x40\xed\x76\x5b\xab\xd5\xea\xda\x42\xfb" \
    "\xfd\x5e\xf3\xf9\x5c\x8e\xe3\x08\x50\x9a\xa6\xef" \
    "\x81\x79\x9e\xab\xdf\xef\xd7\xde\x65\x40\x51\x14" \
    "\x5d\x90\x49\xcd\x3b\x93\x3b\xde\x5a\xab\x28\x8a" \
    "\x14\x04\x81\x5c\xd7\x15\xa0\x4e\xa7\xa3\x30\x0c" \
    "\x95\x65\xd9\x63\x65\x8f\xe8\xe4\xae\xc2\xbf\xe4" \
    "\x06\x9d\x54\xb6\xfc\x09\x7a\x3b\x37\xe7\xc5\xaf" \
    "\xe5\x1f\x9e\x08\xdc\x9a\x76\xc7\x9d\xf6\x00\x00" \
...
class MinimizeEnergyPropDialog(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        if not name:
            self.setName("MinimizeEnergyPropDialog")

        self.setIcon(self.image0)

        MinimizeEnergyPropDialogLayout = QVBoxLayout(self,0,0,"MinimizeEnergyPropDialogLayout")
        ...
        self.heading_pixmap.setPixmap(self.image0)
        ...
        MinimizeEnergyPropDialogLayout.addWidget(self.heading_frame)
        ...
        self.sponsor_btn.setPixmap(self.image1)
        ...
        self.restore_btn.setIconSet(QIconSet(self.image4))
        ...
        self.buttonGroup8 = QButtonGroup(self.body_frame,"buttonGroup8")
        self.buttonGroup8.setFrameShape(QButtonGroup.StyledPanel)
        self.buttonGroup8.setExclusive(1)
        self.buttonGroup8.setColumnLayout(0,Qt.Vertical)
        self.buttonGroup8.layout().setSpacing(1)
        self.buttonGroup8.layout().setMargin(4)
        buttonGroup8Layout = QVBoxLayout(self.buttonGroup8.layout())
        buttonGroup8Layout.setAlignment(Qt.AlignTop)

        layout37 = QHBoxLayout(None,0,6,"layout37")

        self.min_options_label = QLabel(self.buttonGroup8,"min_options_label")
        self.min_options_label.setPaletteForegroundColor(QColor(0,0,255))
        layout37.addWidget(self.min_options_label)
        spacer21 = QSpacerItem(21,16,QSizePolicy.Expanding,QSizePolicy.Minimum)
        layout37.addItem(spacer21)

        self.grpbtn_1 = QPushButton(self.buttonGroup8,"grpbtn_1")
        ...
        self.grpbtn_1.setIconSet(QIconSet(self.image6))
        self.grpbtn_1.setFlat(1)
        layout37.addWidget(self.grpbtn_1)
        buttonGroup8Layout.addLayout(layout37)

        self.line1 = QFrame(self.buttonGroup8,"line1")
        self.line1.setFrameShape(QFrame.HLine)
        self.line1.setFrameShadow(QFrame.Sunken)
        self.line1.setMidLineWidth(0)
        self.line1.setFrameShape(QFrame.HLine)
        buttonGroup8Layout.addWidget(self.line1)

        self.minimize_all_rbtn = QRadioButton(self.buttonGroup8,"minimize_all_rbtn")
        self.minimize_all_rbtn.setChecked(1)
        buttonGroup8Layout.addWidget(self.minimize_all_rbtn)

        self.minimize_sel_rbtn = QRadioButton(self.buttonGroup8,"minimize_sel_rbtn")
        buttonGroup8Layout.addWidget(self.minimize_sel_rbtn)
        body_frameLayout.addWidget(self.buttonGroup8)

        self.groupBox2 = QGroupBox(self.body_frame,"groupBox2")
        ...
        self.watch_min_options_label = QLabel(self.groupBox2,"watch_min_options_label")
        self.watch_min_options_label.setPaletteForegroundColor(QColor(0,0,255))
        layout39.addWidget(self.watch_min_options_label)
        spacer21_2 = QSpacerItem(20,20,QSizePolicy.Expanding,QSizePolicy.Minimum)
        layout39.addItem(spacer21_2)

        self.grpbtn_2 = QPushButton(self.groupBox2,"grpbtn_2")
        ...
        self.grpbtn_2.setIconSet(QIconSet(self.image6))
        self.grpbtn_2.setFlat(1)
        layout39.addWidget(self.grpbtn_2)
        groupBox2Layout.addLayout(layout39)

        self.line2 = QFrame(self.groupBox2,"line2")
        self.line2.setFrameShape(QFrame.HLine)
        self.line2.setFrameShadow(QFrame.Sunken)
        self.line2.setMidLineWidth(0)
        self.line2.setFrameShape(QFrame.HLine)
        groupBox2Layout.addWidget(self.line2)

        self.watch_minimization_checkbox = QCheckBox(self.groupBox2,"watch_minimization_checkbox")
        self.watch_minimization_checkbox.setChecked(1)
        groupBox2Layout.addWidget(self.watch_minimization_checkbox)
        ...
        self.update_btngrp.layout().setSpacing(1)
        self.update_btngrp.layout().setMargin(3)
        update_btngrpLayout = QVBoxLayout(self.update_btngrp.layout())
        update_btngrpLayout.setAlignment(Qt.AlignTop)

        self.watch_min_options_label_2 = QLabel(self.update_btngrp,"watch_min_options_label_2")
        self.watch_min_options_label_2.setPaletteForegroundColor(QColor(0,0,255))
        update_btngrpLayout.addWidget(self.watch_min_options_label_2)

        self.line2_1 = QFrame(self.update_btngrp,"line2_1")
        self.line2_1.setFrameShape(QFrame.HLine)
        self.line2_1.setFrameShadow(QFrame.Sunken)
        self.line2_1.setMidLineWidth(0)
        self.line2_1.setFrameShape(QFrame.HLine)
        update_btngrpLayout.addWidget(self.line2_1)
        ...
        update_btngrpLayout.addWidget(self.update_asap_rbtn)

        layout109 = QHBoxLayout(None,0,0,"layout109")
        ...
        layout109.addWidget(self.update_every_rbtn)
        ...
        layout109.addWidget(self.update_number_spinbox)

        self.update_units_combobox = QComboBox(0,self.update_btngrp,"update_units_combobox")
        layout109.addWidget(self.update_units_combobox)
        spacer2 = QSpacerItem(16,20,QSizePolicy.Expanding,QSizePolicy.Minimum)
        layout109.addItem(spacer2)
        update_btngrpLayout.addLayout(layout109)
        groupBox2Layout.addWidget(self.update_btngrp)
        body_frameLayout.addWidget(self.groupBox2)

        self.parms_grpbox = QGroupBox(self.body_frame,"parms_grpbox")
        ...
        layout40.addWidget(self.parameters_label)
        spacer21_3 = QSpacerItem(21,16,QSizePolicy.Expanding,QSizePolicy.Minimum)
        layout40.addItem(spacer21_3)

        self.grpbtn_3 = QPushButton(self.parms_grpbox,"grpbtn_3")
        self.grpbtn_3.setSizePolicy(QSizePolicy(QSizePolicy.Fixed,QSizePolicy.Fixed,0,0,self.grpbtn_3.sizePolicy().hasHeightForWidth()))
        self.grpbtn_3.setMaximumSize(QSize(16,16))
        self.grpbtn_3.setAutoDefault(0)
        self.grpbtn_3.setIconSet(QIconSet(self.image6))
        self.grpbtn_3.setFlat(1)
        layout40.addWidget(self.grpbtn_3)
        parms_grpboxLayout.addLayout(layout40)

        self.line3 = QFrame(self.parms_grpbox,"line3")
        self.line3.setFrameShape(QFrame.HLine)
        self.line3.setFrameShadow(QFrame.Sunken)
        self.line3.setMidLineWidth(0)
        self.line3.setFrameShape(QFrame.HLine)
        parms_grpboxLayout.addWidget(self.line3)

        layout79 = QHBoxLayout(None,0,6,"layout79")

        layout77 = QVBoxLayout(None,0,6,"layout77")

        self.endrms_lbl = QLabel(self.parms_grpbox,"endrms_lbl")
        self.endrms_lbl.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        layout77.addWidget(self.endrms_lbl)

        self.endmax_lbl = QLabel(self.parms_grpbox,"endmax_lbl")
        self.endmax_lbl.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        layout77.addWidget(self.endmax_lbl)

        self.cutoverrms_lbl = QLabel(self.parms_grpbox,"cutoverrms_lbl")
        self.cutoverrms_lbl.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        layout77.addWidget(self.cutoverrms_lbl)

        self.cutovermax_lbl = QLabel(self.parms_grpbox,"cutovermax_lbl")
        self.cutovermax_lbl.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        layout77.addWidget(self.cutovermax_lbl)
        layout79.addLayout(layout77)

        layout78 = QVBoxLayout(None,0,6,"layout78")

        self.endrms_linedit = QLineEdit(self.parms_grpbox,"endrms_linedit")
        self.endrms_linedit.setFrameShape(QLineEdit.LineEditPanel)
        self.endrms_linedit.setFrameShadow(QLineEdit.Sunken)
        layout78.addWidget(self.endrms_linedit)

        self.endmax_linedit = QLineEdit(self.parms_grpbox,"endmax_linedit")
        layout78.addWidget(self.endmax_linedit)

        self.cutoverrms_linedit = QLineEdit(self.parms_grpbox,"cutoverrms_linedit")
        ...
        MinimizeEnergyPropDialogLayout.addLayout(layout42)

        self.languageChange()

        self.resize(QSize(245,535).expandedTo(self.minimumSizeHint()))
        ...
        self.connect(self.watch_minimization_checkbox,SIGNAL("toggled(bool)"),self.update_btngrp.setEnabled)
...
"<p>Specify how often to update the model during the minimization. This allows the user to monitor minimization results while the minimization is running.</p>"))
        ...
        self.endrms_lbl.setText(self.__tr("EndRMS (pN) :"))
        self.endmax_lbl.setText(self.__tr("EndMax (pN) :"))
        self.cutoverrms_lbl.setText(self.__tr("CutoverRMS (pN) :"))
...
"<p>Use steepest descent  until the total force on each atom is less than this value.</p>"))
    ...
    def open_sponsor_homepage(self):
        print "MinimizeEnergyPropDialog.open_sponsor_homepage(): Not implemented yet"

    def ok_btn_clicked(self):
        print "MinimizeEnergyPropDialog.ok_btn_clicked(): Not implemented yet"

    def cancel_btn_clicked(self):
        print "MinimizeEnergyPropDialog.cancel_btn_clicked(): Not implemented yet"

    def preview_btn_clicked(self):
        print "MinimizeEnergyPropDialog.preview_btn_clicked(): Not implemented yet"

    def whatsthis_btn_clicked(self):
        print "MinimizeEnergyPropDialog.whatsthis_btn_clicked(): Not implemented yet"

    def restore_defaults_btn_clicked(self):
        print "MinimizeEnergyPropDialog.restore_defaults_btn_clicked(): Not implemented yet"

    def toggle_grpbtn_1(self):
        print "MinimizeEnergyPropDialog.toggle_grpbtn_1(): Not implemented yet"

    def toggle_grpbtn_2(self):
        print "MinimizeEnergyPropDialog.toggle_grpbtn_2(): Not implemented yet"

    def change_width(self):
        print "MinimizeEnergyPropDialog.change_width(): Not implemented yet"

    def change_height(self):
        print "MinimizeEnergyPropDialog.change_height(): Not implemented yet"

    def filename_btn_clicked(self):
        print "MinimizeEnergyPropDialog.filename_btn_clicked(): Not implemented yet"

    def toggle_grpbtn_3(self):
        print "MinimizeEnergyPropDialog.toggle_grpbtn_3(): Not implemented yet"

    def newSlot(self):
        print "MinimizeEnergyPropDialog.newSlot(): Not implemented yet"

    def __tr(self,s,c = None):
        return qApp.translate("MinimizeEnergyPropDialog",s,c)
