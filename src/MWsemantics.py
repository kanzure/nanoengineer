...
#        self.setCaption(self.trUtf8(self.name() + " - " + "[" + self.assy.name + "]"))
    ...
    def zoomTool(self):
        ...
        if self.glpane.mode.modename not in ['ZOOM', 'PAN', 'ROTATE']:
            ...
            self.glpane.prevModeDisplay = self.glpane.mode.display # NFR 426.  Mark 050718.
    ...
    def helpAbout(self):
        ...
        date = "Release Date: July 18, 2005" # This should come from __vdate__ or something similar
