...
#
# Created: Wed Mar 9 18:28:59 2005
...
class ElementSelectorDialog(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        self.elementButtonGroup.layout().setSpacing(6)
        self.elementButtonGroup.layout().setMargin(11)
        ...
        self.resize(QSize(566,467).expandedTo(self.minimumSizeHint()))
