...
findPotentialExtension(struct bondStretch *s, double r0, double pr0, double gr0, double r1, double pr1, double gr1)
{
  ...
  //
  // The third line gives the derivitive, which we want to match the
  // actual gradient function at r1.
  //
  // The last line gives the second derivitive, which we want to be
  ...
  // ^ characters, so r1^3 becomes r13, which we have precomputed.
