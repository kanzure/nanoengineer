...
struct bsdata bstab[]={
    ...
    // singlets
    bondrec(1,0,1,  20.0, 30.0,  0.671,  0.386),	/* X-H */

    bondrec(1,0,3,  20.0, 152.0,  0.671,  0.386),	/* X-Li */
    bondrec(1,0,4,  20.0, 114.0,  0.671,  0.386),	/* X-Be */
    bondrec(1,0,5,  20.0, 90.0,  0.671,  0.386),	/* X-B */
    bondrec(1,0,6,  20.0, 77.0,  0.671,  0.386),	/* X-C */
    bondrec(1,0,7,  20.0, 70.0,  0.671,  0.386),	/* X-N */
    bondrec(1,0,8,  20.0, 66.0,  0.671,  0.386),	/* X-O */
    bondrec(1,0,9,  20.0, 64.0,  0.671,  0.386),	/* X-F */

    bondrec(1,0,11,  20.0, 186.0,  0.671,  0.386),	/* X-Na */
    bondrec(1,0,12,  20.0, 160.0,  0.671,  0.386),	/* X-Mg */
    bondrec(1,0,13,  20.0, 143.0,  0.671,  0.386),	/* X-Al */
    bondrec(1,0,14,  20.0, 117.0,  0.671,  0.386),	/* X-Si */
    bondrec(1,0,15,  20.0, 110.0,  0.671,  0.386),	/* X-P */
    bondrec(1,0,16,  20.0, 104.0,  0.671,  0.386),	/* X-S */
    bondrec(1,0,17,  20.0, 99.0,  0.671,  0.386),	/* X-Cl */

    bondrec(1,0,19,  20.0, 231.0,  0.671,  0.386),	/* X-K */
    bondrec(1,0,20,  20.0, 197.0,  0.671,  0.386),	/* X-Ca */
    bondrec(1,0,21,  20.0, 160.0,  0.671,  0.386),	/* X-Sc */
    bondrec(1,0,22,  20.0, 147.0,  0.671,  0.386),	/* X-Ti */
    bondrec(1,0,23,  20.0, 132.0,  0.671,  0.386),	/* X-V */
    bondrec(1,0,24,  20.0, 125.0,  0.671,  0.386),	/* X-Cr */
    bondrec(1,0,25,  20.0, 112.0,  0.671,  0.386),	/* X-Mn */
    bondrec(1,0,26,  20.0, 124.0,  0.671,  0.386),	/* X-Fe */
    bondrec(1,0,27,  20.0, 125.0,  0.671,  0.386),	/* X-Co */
    bondrec(1,0,28,  20.0, 125.0,  0.671,  0.386),	/* X-Ni */
    bondrec(1,0,29,  20.0, 128.0,  0.671,  0.386),	/* X-Cu */
    bondrec(1,0,30,  20.0, 133.0,  0.671,  0.386),	/* X-Zn */
    bondrec(1,0,31,  20.0, 135.0,  0.671,  0.386),	/* X-Ga */
    bondrec(1,0,32,  20.0, 122.0,  0.671,  0.386),	/* X-Ge */
    bondrec(1,0,33,  20.0, 119.0,  0.671,  0.386),	/* X-As */
    bondrec(1,0,34,  20.0, 120.0,  0.671,  0.386),	/* X-Se */
    bondrec(1,0,35,  20.0, 119.0,  0.671,  0.386),	/* X-Br */

    bondrec(1,0,51,  20.0, 119.0,  0.671,  0.386),	/* X-An */
    bondrec(1,0,52,  20.0, 120.0,  0.671,  0.386),	/* X-Te */
    bondrec(1,0,53,  20.0, 119.0,  0.671,  0.386),	/* X-I */
...
struct angben bendata[]={
    // default for any atom with singlets
    benrec(0,1,6,1,0, 360, 1.909),	/* X-C-X */
