...
class PovrayScenePropDialog(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        self.line3 = QFrame(self.output_image_grpbox,"line3")
        self.line3.setFrameShape(QFrame.HLine)
        self.line3.setFrameShadow(QFrame.Sunken)
        self.line3.setMidLineWidth(0)
        self.line3.setFrameShape(QFrame.HLine)
        output_image_grpboxLayout.addWidget(self.line3)

        layout14 = QHBoxLayout(None,0,6,"layout14")

        layout12 = QVBoxLayout(None,0,6,"layout12")

        self.output_type_label = QLabel(self.output_image_grpbox,"output_type_label")
        self.output_type_label.setAlignment(QLabel.AlignVCenter | QLabel.AlignRight)
        layout12.addWidget(self.output_type_label)
        ...
        layout12.addWidget(self.width_label)
        ...
        layout12.addWidget(self.height_label)
        ...
        layout12.addWidget(self.aspect_ratio_label)
        layout14.addLayout(layout12)

        layout13 = QVBoxLayout(None,0,6,"layout13")

        self.output_type_combox = QComboBox(0,self.output_image_grpbox,"output_type_combox")
        layout13.addWidget(self.output_type_combox)
        ...
        layout13.addWidget(self.width_spinbox)
        ...
        layout13.addWidget(self.height_spinbox)

        self.aspect_ratio_value_label = QLabel(self.output_image_grpbox,"aspect_ratio_value_label")
        self.aspect_ratio_value_label.setAlignment(QLabel.AlignVCenter | QLabel.AlignLeft)
        layout13.addWidget(self.aspect_ratio_value_label)
        layout14.addLayout(layout13)
        output_image_grpboxLayout.addLayout(layout14)
...
"<p>The POV-Ray Scene file node name as it appears in the Model Tree.</p>"))
        ...
        self.output_type_label.setText(self.__tr("Output Type :"))
        ...
        self.aspect_ratio_value_label.setText(self.__tr("1.333 to 1"))
    ...
    def filename_btn_clicked(self):
        print "PovrayScenePropDialog.filename_btn_clicked(): Not implemented yet"
