...
# Form implementation generated from reading ui file 'C:\atom\cad\src\PovrayScenePropDialog.ui'
#
# Created: Fri Jun 2 17:28:15 2006
...
image0_data = \
    ...
    "\x5d\x49\x44\x41\x54\x78\x9c\xad\x94\x5f\x48\x93" \
    ...
    "\x9b\x60\x6d\x8f\xfe\x01\x95\xbb\xf0\xe5\x05\x4d" \
    "\x49\x3c\x00\x00\x00\x00\x49\x45\x4e\x44\xae\x42" \
    "\x60\x82"
image1_data = \
    "\x89\x50\x4e\x47\x0d\x0a\x1a\x0a\x00\x00\x00\x0d" \
...
class PovrayScenePropDialog(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        self.grpbtn_3 = QPushButton(self.output_image_grpbox,"grpbtn_3")
        ...
        self.grpbtn_3.setIconSet(QIconSet(self.image8))
        self.grpbtn_3.setFlat(1)
        layout44.addWidget(self.grpbtn_3)
        ...
        self.render_and_save_image_btn = QPushButton(self.output_image_grpbox,"render_and_save_image_btn")
        output_image_grpboxLayout.addWidget(self.render_and_save_image_btn)
        ...
        self.resize(QSize(204,406).expandedTo(self.minimumSizeHint()))
        ...
        self.connect(self.render_and_save_image_btn,SIGNAL("clicked()"),self.render_and_save_image)
...
"<p>The POV-Ray Scene file is placed in the <b>povray</b> directory next to the current part.</p>"))
        ...
        self.render_and_save_image_btn.setText(self.__tr("Render and Save Image"))
        QToolTip.add(self.render_and_save_image_btn,self.__tr("Render and Save Image"))
        QWhatsThis.add(self.render_and_save_image_btn,self.__tr("<b>Render and Save Image</b>\n"
"<p>Press this button to render a new image from the POV-Ray Scene file. The current values in the POV-Ray Scene property manager are used to render the image.</p>"))
    ...
    def render_and_save_image(self):
        print "PovrayScenePropDialog.render_and_save_image(): Not implemented yet"
    ...
    def update_width_when_height_changes(self):
        print "PovrayScenePropDialog.update_width_when_height_changes(): Not implemented yet"

    def update_height_when_width_changes(self):
        print "PovrayScenePropDialog.update_height_when_width_changes(): Not implemented yet"
