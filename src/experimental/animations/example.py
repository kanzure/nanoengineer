...
if False:
    ...
    z = m.translucentTitleSequence('Titles_31_Aug_2006/1_Title.gif',
                                   os.path.join(animate.mpeg_dir,
    ...
    m.translucentTitleSequence('Titles_31_Aug_2006/2_InitialText.gif',
                               os.path.join(animate.mpeg_dir,
                                            'slow_cpk_jpeg/' + struct_name + '.%06d.jpg'),
                               start=z,
    ...
    z = m.crossfade(os.path.join(animate.mpeg_dir,
                                 'slow_cpk_jpeg/' + struct_name + '.%06d.jpg'),
                    os.path.join(animate.mpeg_dir,
    ...
    z = m.translucentTitleSequence('Titles_31_Aug_2006/4_0.6ps.gif',
                                   os.path.join(animate.mpeg_dir,
                                                'fastjpeg/' + struct_name + '.%06d.jpg'),
    ...
    z = m.translucentTitleSequence('Titles_31_Aug_2006/5_6.0ps.gif',
                                   os.path.join(animate.mpeg_dir,
                                                'slowjpeg/' + struct_name + '.%06d.jpg'),
                                   start=0, incr=10, frames=8*m.SECOND, avg=10)
    # then
    ...
    z = m.translucentTitleSequence('Titles_31_Aug_2006/6_6.0ps_Jumpy.gif',
                                   os.path.join(animate.mpeg_dir,
                                                'slowjpeg/' + struct_name + '.%06d.jpg'),
