...
String MoleculaT::pdb ()
{
    return pdb(NULL);
}

String MoleculaT::pdb (String inf)
{
    formato fo = formato (8, "#0.000");
    formato fdec = formato (7, "#0.000");	//para los doble precision
    formato fi = formato (5, "#####");	//para los enteros
    StringBuffer pdb = StringBuffer
	("REMARK ==============================================================================\n");
...
String MoleculaT::mmp ()
{
    return mmp(NULL);
}

String MoleculaT::mmp (String inf)
{
    formato fo = formato (8, "#0.000");
    formato fdec = formato (7, "#0.000");	//para los doble precision
    formato fi = formato (5, "#####");	//para los enteros
    StringBuffer mmp = StringBuffer
