...
{   M1=A;M2=B;M3=C;
    ...
    ssalida.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Output PDB structure"),
	  		                                 BorderFactory.createEtchedBorder(1)));
	botpanel=new JPanel();	botpanel.setLayout(new FlowLayout());
	B1    =new JButton("Heterojunction");	 	  B1.addActionListener(this);botpanel.add(B1);
	B2    =new JButton("Single-Walled Nanotube");	  B2.addActionListener(this);botpanel.add(B2);
	B3    =new JButton("Multi-Walled Nanotube");	  B3.addActionListener(this);botpanel.add(B3);
...
public void actionPerformed(ActionEvent ev){
	 ...
	 if       (etiq=="Heterojunction")	 	 {inf=M1.getInfo();printpdb(M1);}
	 else if  (etiq=="Single-Walled Nanotube")	 {inf=M2.getInfo();printpdb(M2);}
	 else if  (etiq=="Multi-Walled Nanotube")	 {inf=M3.getInfo();printpdb(M3);}

	 }

public void printpdb(String s){salida.setText(s+" "+this.getRootPane().getUIClassID() );}
...
StringBuffer pdb=new StringBuffer("REMARK ==============================================================================\n"+
 				"REMARK "+inf+"\n"+
 ...
 pdb=pdb.append("END");
 if (mmol.nvert>=1)     {salida.setText(pdb+"");System.out.print(pdb+"");}
 else if (mmol.nvert==0)salida.setText("Hmm.. It seems there is no molecule at all. Just use the Create Button") ;
 else salida.setText("Error raro");
