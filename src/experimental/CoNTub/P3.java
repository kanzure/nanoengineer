...
{     pweb=new JEditorPane();
	  ...
	  try { s = "http://www.ugr.es/local/gmdm/java/contub/help/help.html";
	        URL helpURL = new URL(s);
	        pweb.setPage(helpURL);    }
      catch (Exception e) {  System.err.println("Couldn't create help URL: " + s);  }
    ...
    pwebscroll.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("HELP."),
