...
public class GLienzo extends JPanel implements MouseListener{
	...
	public void paint(Graphics g) {
		...
		g.drawLine((int)(centrox+e*x1),(int)(centroy-e*y1),
			   (int)(centrox+e*x2),(int)(centroy-e*y2));
		...
		g.setColor(Color.magenta);
		g.drawLine((int)(centrox+e* x1),    (int)(centroy-e* y1),
			   (int)(centrox+e*(x1+xh)),(int)(centroy-e*(y1+yh)));
		g.setColor(Color.blue);
		g.drawLine((int)(centrox+e* x1),    (int)(centroy-e* y1),
			   (int)(centrox+e*(x1+xp)),(int)(centroy-e*(y1+yp)));
