...
public class GLienzo2 extends JPanel implements MouseListener{
	...
	public void paint(Graphics g) {
		...
		if (ph) g.drawString("p-h, h en ("+na+","+ma+")",10,-10+2*centroy);
		else    g.drawString("h-, p en ("+na+","+ma+")",10,-10+2*centroy);
	}
	...
	public void mousePressed (MouseEvent ev){
		...
		int nn2=n2;
		int nm2=m2;
		if (ev.getButton()==MouseEvent.BUTTON1) { nn2=-m2; nm2=n2+m2;}
		if (ev.getButton()==MouseEvent.BUTTON3) ph=!ph;
