...
class GridPlanePropDialog(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        GridPlanePropDialogLayout = QVBoxLayout(self,11,6,"GridPlanePropDialogLayout")
        ...
        layout14.addWidget(self.textLabel1_3)
        ...
        self.uwLineEdit.setMinimumSize(QSize(0,30))
        layout13.addWidget(self.uwLineEdit)
        ...
        self.htLineEdit = QLineEdit(self,"htLineEdit")
        self.htLineEdit.setMinimumSize(QSize(0,30))
        layout16.addWidget(self.htLineEdit)

        self.uhLineEdit = QLineEdit(self,"uhLineEdit")
        self.uhLineEdit.setMinimumSize(QSize(0,30))
        self.uhLineEdit.setFrameShape(QLineEdit.LineEditPanel)
        self.uhLineEdit.setFrameShadow(QLineEdit.Sunken)
        layout16.addWidget(self.uhLineEdit)
        ...
        GridPlanePropDialogLayout.addLayout(layout19)
        spacer5 = QSpacerItem(101,150,QSizePolicy.Minimum,QSizePolicy.Expanding)
        GridPlanePropDialogLayout.addItem(spacer5)
        ...
        GridPlanePropDialogLayout.addLayout(layout16_2)
    ...
    def changePlaneColor(self):
        print "GridPlanePropDialog.changePlaneColor(): Not implemented yet"

    def changeGridColor(self):
        print "GridPlanePropDialog.changeGridColor(): Not implemented yet"
