...
#define INFO(fmt) (printError(tracef, __FILE__, __LINE__, "Info", 0, fmt))
#define INFO1(fmt,a) (printError(tracef, __FILE__, __LINE__, "Info", 0, fmt, a))
#define INFO2(fmt,a,b) (printError(tracef, __FILE__, __LINE__, "Info", 0, fmt, a, b))
#define INFO3(fmt,a,b,c) (printError(tracef, __FILE__, __LINE__, "Info", 0, fmt, a, b, c))
#define INFO4(fmt,a,b,c,d) (printError(tracef, __FILE__, __LINE__, "Info", 0, fmt, a, b, c, d))
